...
import { BookOpen, AlertTriangle, ArrowRight, Award } from 'lucide-react';
...
export const TimetableDashboardWidget: React.FC<DashboardWidgetProps> = ({
  ...
  return (
    <div className="w-full space-y-4">
      ...
      {upcomingAssessment && (
        <div className="w-full bg-gradient-to-r from-red-950 to-slate-950 border border-red-900/60 rounded-2xl p-4 flex items-start gap-4 shadow-xl shadow-red-950/10 animate-pulse-slow">
