  ...
  sections: [
    {
      ...
      blocs: [
        ...
        },
        {
          ...
          gf: "Calme-toi, petit(e). Je te comprends à 100%. Mais il ne faut pas avoir peur ! Laisse-moi te soulager tout de suite : tu n'as pas besoin de tout réapprendre. Tu te souviens des limites ? Bah, la dérivée, c'est juste le petit frère des limites. C'est la limite du taux d'accroissement !",
        },
        {
          type: 'dialogue',
          id: 'b7',
