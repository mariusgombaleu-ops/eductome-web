// ============================================================================
// GABARIT VIDE — Tome 11 — Les Équations Différentielles (Série D).
...
//
// ⚠️ NON ENREGISTRÉ dans le registry tant que le cours « t11-equations-diff » n'est pas câblé
//    dans le courseRegistry du CourseReader : le bilan redirige vers
//    /dashboard/course/t11-equations-diff. Une fois le contenu rempli ET le cours disponible,
...
export const examT11EquationsDiff: ExamData = {
  id: 't11-equations-diff',
  tome: "Tome 11 — Les Équations Différentielles",
  matiere: 'Mathématiques · Série D',
  sousTitre: "Équations différentielles",
  moduleRedirect: { label: "Réviser le cours — Tome 11 — Les Équations Différentielles", courseId: 't11-equations-diff' },
...
export default examT11EquationsDiff;
