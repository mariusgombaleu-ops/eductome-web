// ============================================================================
// GABARIT VIDE — Tome 4 — Les Suites Numériques (Série D).
...
//
// ⚠️ NON ENREGISTRÉ dans le registry tant que le cours « t4-suites » n'est pas câblé
//    dans le courseRegistry du CourseReader : le bilan redirige vers
//    /dashboard/course/t4-suites. Une fois le contenu rempli ET le cours disponible,
...
export const examT4Suites: ExamData = {
  ...
  moduleRedirect: { label: "Réviser le cours — Tome 4 — Les Suites Numériques", courseId: 't4-suites' },
