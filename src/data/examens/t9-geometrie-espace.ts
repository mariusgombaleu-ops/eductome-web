// ============================================================================
// GABARIT VIDE — Tome 9 — Géométrie dans l'Espace (Série D).
...
//
// ⚠️ NON ENREGISTRÉ dans le registry tant que le cours « t9-geometrie-espace » n'est pas câblé
//    dans le courseRegistry du CourseReader : le bilan redirige vers
//    /dashboard/course/t9-geometrie-espace. Une fois le contenu rempli ET le cours disponible,
...
export const examT9GeometrieEspace: ExamData = {
  id: 't9-geometrie-espace',
  tome: "Tome 9 — Géométrie dans l'Espace",
  matiere: 'Mathématiques · Série D',
  sousTitre: "Géométrie de l'espace",
  moduleRedirect: { label: "Réviser le cours — Tome 9 — Géométrie dans l'Espace", courseId: 't9-geometrie-espace' },
...
export default examT9GeometrieEspace;
