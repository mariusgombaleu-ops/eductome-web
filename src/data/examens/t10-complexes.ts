// ============================================================================
// GABARIT VIDE — Tome 10 — Les Nombres Complexes (Série D).
...
//
// ⚠️ NON ENREGISTRÉ dans le registry tant que le cours « t10-complexes » n'est pas câblé
//    dans le courseRegistry du CourseReader : le bilan redirige vers
//    /dashboard/course/t10-complexes. Une fois le contenu rempli ET le cours disponible,
...
export const examT10Complexes: ExamData = {
  id: 't10-complexes',
  tome: "Tome 10 — Les Nombres Complexes",
  matiere: 'Mathématiques · Série D',
  sousTitre: "Nombres complexes",
  moduleRedirect: { label: "Réviser le cours — Tome 10 — Les Nombres Complexes", courseId: 't10-complexes' },
...
export default examT10Complexes;
