// ============================================================================
// GABARIT VIDE — Tome 12 — Révisions BAC (Série D).
...
//
// ⚠️ NON ENREGISTRÉ dans le registry tant que le cours « t12-revisions-bac » n'est pas câblé
//    dans le courseRegistry du CourseReader : le bilan redirige vers
//    /dashboard/course/t12-revisions-bac. Une fois le contenu rempli ET le cours disponible,
...
export const examT12RevisionsBac: ExamData = {
  id: 't12-revisions-bac',
  tome: "Tome 12 — Révisions BAC",
  matiere: 'Mathématiques · Série D',
  sousTitre: "Révisions BAC",
  moduleRedirect: { label: "Réviser le cours — Tome 12 — Révisions BAC", courseId: 't12-revisions-bac' },
...
export default examT12RevisionsBac;
