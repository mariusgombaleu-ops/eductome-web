// ============================================================================
// GABARIT VIDE — Tome 5 — Logarithme & Exponentielle (Série D).
...
//
// ⚠️ NON ENREGISTRÉ dans le registry tant que le cours « t5-log-expo » n'est pas câblé
//    dans le courseRegistry du CourseReader : le bilan redirige vers
//    /dashboard/course/t5-log-expo. Une fois le contenu rempli ET le cours disponible,
...
export const examT5LogExpo: ExamData = {
  ...
  moduleRedirect: { label: "Réviser le cours — Tome 5 — Logarithme & Exponentielle", courseId: 't5-log-expo' },
