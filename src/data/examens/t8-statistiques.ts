// ============================================================================
// GABARIT VIDE — Tome 8 — Les Statistiques (Série D).
...
//
// ⚠️ NON ENREGISTRÉ dans le registry tant que le cours « t8-statistiques » n'est pas câblé
//    dans le courseRegistry du CourseReader : le bilan redirige vers
//    /dashboard/course/t8-statistiques. Une fois le contenu rempli ET le cours disponible,
...
export const examT8Statistiques: ExamData = {
  id: 't8-statistiques',
  tome: "Tome 8 — Les Statistiques",
  matiere: 'Mathématiques · Série D',
  sousTitre: "Statistiques",
  moduleRedirect: { label: "Réviser le cours — Tome 8 — Les Statistiques", courseId: 't8-statistiques' },
...
export default examT8Statistiques;
