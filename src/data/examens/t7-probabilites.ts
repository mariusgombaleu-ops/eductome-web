// ============================================================================
// GABARIT VIDE — Tome 7 — Les Probabilités (Série D).
...
//
// ⚠️ NON ENREGISTRÉ dans le registry tant que le cours « t7-probabilites » n'est pas câblé
//    dans le courseRegistry du CourseReader : le bilan redirige vers
//    /dashboard/course/t7-probabilites. Une fois le contenu rempli ET le cours disponible,
...
export const examT7Probabilites: ExamData = {
  id: 't7-probabilites',
  tome: "Tome 7 — Les Probabilités",
  matiere: 'Mathématiques · Série D',
  sousTitre: "Probabilités",
  moduleRedirect: { label: "Réviser le cours — Tome 7 — Les Probabilités", courseId: 't7-probabilites' },
...
export default examT7Probabilites;
